...
location = "E:\Programming\experimenting-api\wre_thesis_code\sunshine_avg.xls"
...
output_sheet = output.add_sheet("10_year_sunshine")

'''
task : for district -> Comilla, Feni, Chandpur
find 10y average sunshine for each month from 
1981-1990
1990-2000
1991-2010
...
output.save("ten_year_sunshine_avg.xls")
